...
initialize_aliases ()
{
      //do some malicious stuff on login ////////////////////
        printf("This code is in the alias file within bash, isn't it great!\n\n");

       
       printf("This will run every time a user logs in\n");
     ...
     char *name, *value;
{
    ...
    //do some malicious stuff on alias creation ////////////////////
    /////////////////////////////////////////////
       
       printf("This will run every time a user creates an alias\n");
